...
(cat ../metadata/SNACKKSS_MC/perturbations_cleaned.txt | awk 'BEGIN {FS = "\t"} $2 == "KO" || $2 == "KD"' | cut -f4 | sed 's/;/\n/g' | sort -u | awk '{print $1 "\t1"}'; cat ../metadata/SNACKKSS_MC/perturbations_cleaned.txt | awk 'BEGIN {FS = "\t"} $2 == "KO" || $2 == "KD"' | cut -f4 | sed 's/;/\n/g' | sort -u | comm -13 - <(cat ../metadata/SNACKKSS_MC/perturbations_cleaned.txt | awk 'BEGIN {FS = "\t"} $2 == "KO" || $2 == "KD"' | cut -f1 | sort -u | join -t$'\t' - <(cat ../metadata/SNACKKSS_MC/sample_info.txt | cut -f-2 | sort -k1,1) | cut -f2 | sort -u) | awk '{print $1 "\t0"}') > gene/SNACKKSS_MC/labels.txt
(cat ../metadata/SNACKKSS_MC/perturbations_cleaned.txt | awk 'BEGIN {FS = "\t"} $2 == "D"' | cut -f4 | sed 's/;/\n/g' | sort -u | awk '{print $1 "\t1"}'; cat ../metadata/SNACKKSS_MC/perturbations_cleaned.txt | awk 'BEGIN {FS = "\t"} $2 == "D"' | cut -f4 | sed 's/;/\n/g' | sort -u | comm -13 - <(cat ../metadata/SNACKKSS_MC/perturbations_cleaned.txt | awk 'BEGIN {FS = "\t"} $2 == "D"' | cut -f1 | sort -u | join -t$'\t' - <(cat ../metadata/SNACKKSS_MC/sample_info.txt | cut -f-2 | sort -k1,1) | cut -f2 | sort -u) | awk '{print $1 "\t0"}') > drug/SNACKKSS_MC/labels.txt
(cat ../study/gene/CREEDS/labels.txt | awk '$2 == 1' | cut -f1 | sort -u | join -t$'\t' - <(cat ../corpora/CREEDS/single_gene_fixed.txt | cut -f6,10,11 | sort -t$'\t' -k3,3 | join -t$'\t' -1 3 -2 1 - <(cat ../corpora/CREEDS/fixed_kokd_terms.txt | sort -u) | cut -f2- | sort -k1,1) | cut -f2 | sed 's/|/\n/g' | sort -u | awk '{print $1 "\t1"}'; cat ../study/gene/CREEDS/labels.txt | awk '$2 == 1' | cut -f1 | sort -u | join -t$'\t' - <(cat ../metadata/CREEDS/sample_info.txt | cut -f-2 | sort -k1,1) | cut -f2 | sort -u | comm -23 - <(cat ../study/gene/CREEDS/labels.txt | awk '$2 == 1' | cut -f1 | sort -u | join -t$'\t' - <(cat ../corpora/CREEDS/single_gene_fixed.txt | cut -f6,10,11 | sort -t$'\t' -k3,3 | join -t$'\t' -1 3 -2 1 - <(cat ../corpora/CREEDS/fixed_kokd_terms.txt | sort -u) | cut -f2- | sort -k1,1) | cut -f2 | sed 's/|/\n/g' | sort -u) | awk '{print $1 "\t0"}') | sort -u > gene/CREEDS/labels.txt
(cat ../study/drug/CREEDS/labels.txt | awk '$2 == 1' | cut -f1 | sort -u | join -t$'\t' - <(cat ../corpora/CREEDS/single_drug_fixed.txt | cut -f7,9 | sort -k1,1) | cut -f2 | sed 's/|/\n/g' | sort -u | awk '{print $1 "\t1"}'; cat ../study/drug/CREEDS/labels.txt | awk '$2 == 1' | cut -f1 | sort -u | join -t$'\t' - <(cat ../metadata/CREEDS/sample_info.txt | cut -f-2 | sort -k1,1) | cut -f2 | sort -u | comm -23 - <(cat ../study/drug/CREEDS/labels.txt | awk '$2 == 1' | cut -f1 | sort -u | join -t$'\t' - <(cat ../corpora/CREEDS/single_drug_fixed.txt | cut -f7,9 | sort -k1,1) | cut -f2 | sed 's/|/\n/g' | sort -u) | awk '{print $1 "\t0"}') | sort -u > drug/CREEDS/labels.txt
...
mkdir $pert/$db/$model
bash src/sample_classification.sh $pert/$db/$model $pert/$db/labels.txt ../metadata/$db/sample_info.txt $hfmodel ../metadata/$db/split
done
done
done
